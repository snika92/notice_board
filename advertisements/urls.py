...
urlpatterns = [
    ...
    path(
        "<int:ad_pk>/comments/create/",
        CommentCreateApiView.as_view(),
        name="comment_create",
    ),
    path(
        "<int:ad_pk>/comments/<int:pk>/update/",
        CommentUpdateApiView.as_view(),
        name="comment_update",
    ),
    path(
        "<int:ad_pk>/comments/<int:pk>/delete/",
        CommentDestroyApiView.as_view(),
        name="comment_delete",
    ),
    path(
        "users_comments/", UsersCommentListApiView.as_view(), name="users_comments_list"
    ),
    path(
        "users_comments/<int:pk>/update/",
        CommentUpdateApiView.as_view(),
        name="user_comment_update",
    ),
    path(
        "users_comments/<int:pk>/delete/",
        CommentDestroyApiView.as_view(),
